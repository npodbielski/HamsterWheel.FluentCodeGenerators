...
curl -X GET --location "https://g.np0.pl/hamster-wheel/fluentcodegenerators/-/badges/release.svg" -H "Cookie: $COOKIE" -o release.svg
curl -X GET --location "https://g.np0.pl/hamster-wheel/fluentcodegenerators/badges/master/pipeline.svg?ignore_skipped=true" -H "Cookie: $COOKIE" -o pipeline.svg
curl -X GET --location "https://g.np0.pl/hamster-wheel/fluentcodegenerators/badges/master/coverage.svg" -H "Cookie: $COOKIE" -o coverage.svg

scp -r ./ vps:/opt/wordpress/html/wp-content/uploads/fluent-code-generator-badges